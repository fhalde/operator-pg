...
public class TopologySpreadConstraints implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.topologyspreadconstraints.LabelSelector labelSelector;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.topologyspreadconstraints.LabelSelector getLabelSelector() {
        return labelSelector;
    }

    public void setLabelSelector(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.topologyspreadconstraints.LabelSelector labelSelector) {
