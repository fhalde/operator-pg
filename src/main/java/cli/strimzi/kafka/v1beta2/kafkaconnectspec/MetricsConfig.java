...
public class MetricsConfig implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.metricsconfig.ValueFrom valueFrom;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.metricsconfig.ValueFrom getValueFrom() {
        return valueFrom;
    }

    public void setValueFrom(cli.strimzi.kafka.v1beta2.kafkaconnectspec.metricsconfig.ValueFrom valueFrom) {
