...
public class ServiceAccount implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.Metadata metadata;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.Metadata metadata) {
