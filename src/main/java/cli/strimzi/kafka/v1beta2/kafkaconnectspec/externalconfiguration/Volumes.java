...
public class Volumes implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.ConfigMap configMap;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.ConfigMap getConfigMap() {
        return configMap;
    }

    public void setConfigMap(cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.ConfigMap configMap) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.Secret secret;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.Secret getSecret() {
        return secret;
    }

    public void setSecret(cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.Secret secret) {
        this.secret = secret;
    }
