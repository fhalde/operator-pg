...
public class ValueFrom implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.metricsconfig.valuefrom.ConfigMapKeyRef configMapKeyRef;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.metricsconfig.valuefrom.ConfigMapKeyRef getConfigMapKeyRef() {
        return configMapKeyRef;
    }

    public void setConfigMapKeyRef(cli.strimzi.kafka.v1beta2.kafkaconnectspec.metricsconfig.valuefrom.ConfigMapKeyRef configMapKeyRef) {
