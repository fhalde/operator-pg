...
public class Authentication implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.AccessToken accessToken;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.AccessToken getAccessToken() {
        return accessToken;
    }

    public void setAccessToken(cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.AccessToken accessToken) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.CertificateAndKey certificateAndKey;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.CertificateAndKey getCertificateAndKey() {
        return certificateAndKey;
    }

    public void setCertificateAndKey(cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.CertificateAndKey certificateAndKey) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.ClientSecret clientSecret;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.ClientSecret getClientSecret() {
        return clientSecret;
    }

    public void setClientSecret(cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.ClientSecret clientSecret) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.PasswordSecret passwordSecret;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.PasswordSecret getPasswordSecret() {
        return passwordSecret;
    }

    public void setPasswordSecret(cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.PasswordSecret passwordSecret) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.RefreshToken refreshToken;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.RefreshToken getRefreshToken() {
        return refreshToken;
    }

    public void setRefreshToken(cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.RefreshToken refreshToken) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.TlsTrustedCertificates> tlsTrustedCertificates;

    public java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.TlsTrustedCertificates> getTlsTrustedCertificates() {
        return tlsTrustedCertificates;
    }

    public void setTlsTrustedCertificates(java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.TlsTrustedCertificates> tlsTrustedCertificates) {
