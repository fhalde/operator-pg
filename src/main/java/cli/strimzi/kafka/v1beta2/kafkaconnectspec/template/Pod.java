...
public class Pod implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Affinity affinity;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliases> hostAliases;

    public java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliases> getHostAliases() {
        return hostAliases;
    }

    public void setHostAliases(java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliases> hostAliases) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecrets> imagePullSecrets;

    public java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecrets> getImagePullSecrets() {
        return imagePullSecrets;
    }

    public void setImagePullSecrets(java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecrets> imagePullSecrets) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Metadata metadata;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Metadata metadata) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.SecurityContext securityContext;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.SecurityContext getSecurityContext() {
        return securityContext;
    }

    public void setSecurityContext(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.SecurityContext securityContext) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Tolerations> tolerations;

    public java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Tolerations> getTolerations() {
        return tolerations;
    }

    public void setTolerations(java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Tolerations> tolerations) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraints> topologySpreadConstraints;

    public java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraints> getTopologySpreadConstraints() {
        return topologySpreadConstraints;
    }

    public void setTopologySpreadConstraints(java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraints> topologySpreadConstraints) {
