...
public class JvmOptions implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private cli.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions._XX _XX;

    public cli.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions._XX get_XX() {
        return _XX;
    }

    public void set_XX(cli.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions._XX _XX) {
        this._XX = _XX;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions.JavaSystemProperties> javaSystemProperties;

    public java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions.JavaSystemProperties> getJavaSystemProperties() {
        return javaSystemProperties;
    }

    public void setJavaSystemProperties(java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions.JavaSystemProperties> javaSystemProperties) {
