...
public class KafkaConnectStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectstatus.Conditions> conditions;

    public java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectstatus.Conditions> conditions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectstatus.ConnectorPlugins> connectorPlugins;

    public java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectstatus.ConnectorPlugins> getConnectorPlugins() {
        return connectorPlugins;
    }

    public void setConnectorPlugins(java.util.List<cli.strimzi.kafka.v1beta2.kafkaconnectstatus.ConnectorPlugins> connectorPlugins) {
