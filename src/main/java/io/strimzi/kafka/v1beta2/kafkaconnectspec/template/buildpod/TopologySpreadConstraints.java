...
public class TopologySpreadConstraints implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.topologyspreadconstraints.LabelSelector labelSelector;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.topologyspreadconstraints.LabelSelector getLabelSelector() {
        return labelSelector;
    }

    public void setLabelSelector(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.topologyspreadconstraints.LabelSelector labelSelector) {
