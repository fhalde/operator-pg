...
public class PodDisruptionBudget implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.template.poddisruptionbudget.Metadata metadata;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.template.poddisruptionbudget.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.poddisruptionbudget.Metadata metadata) {
