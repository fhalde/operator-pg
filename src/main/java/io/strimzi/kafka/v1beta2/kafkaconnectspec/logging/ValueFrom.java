...
public class ValueFrom implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.logging.valuefrom.ConfigMapKeyRef configMapKeyRef;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.logging.valuefrom.ConfigMapKeyRef getConfigMapKeyRef() {
        return configMapKeyRef;
    }

    public void setConfigMapKeyRef(io.strimzi.kafka.v1beta2.kafkaconnectspec.logging.valuefrom.ConfigMapKeyRef configMapKeyRef) {
