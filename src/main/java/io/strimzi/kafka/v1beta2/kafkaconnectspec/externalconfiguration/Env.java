...
public class Env implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.env.ValueFrom valueFrom;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.env.ValueFrom getValueFrom() {
        return valueFrom;
    }

    public void setValueFrom(io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.env.ValueFrom valueFrom) {
