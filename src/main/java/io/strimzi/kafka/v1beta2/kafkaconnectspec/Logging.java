...
public class Logging implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.logging.Loggers loggers;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.logging.Loggers getLoggers() {
        return loggers;
    }

    public void setLoggers(io.strimzi.kafka.v1beta2.kafkaconnectspec.logging.Loggers loggers) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.logging.ValueFrom valueFrom;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.logging.ValueFrom getValueFrom() {
        return valueFrom;
    }

    public void setValueFrom(io.strimzi.kafka.v1beta2.kafkaconnectspec.logging.ValueFrom valueFrom) {
