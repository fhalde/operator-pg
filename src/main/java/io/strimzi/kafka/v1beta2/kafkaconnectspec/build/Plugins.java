...
public class Plugins implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.build.plugins.Artifacts> artifacts;

    public java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.build.plugins.Artifacts> getArtifacts() {
        return artifacts;
    }

    public void setArtifacts(java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.build.plugins.Artifacts> artifacts) {
