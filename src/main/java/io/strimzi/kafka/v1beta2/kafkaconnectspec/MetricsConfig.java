...
public class MetricsConfig implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.metricsconfig.ValueFrom valueFrom;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.metricsconfig.ValueFrom getValueFrom() {
        return valueFrom;
    }

    public void setValueFrom(io.strimzi.kafka.v1beta2.kafkaconnectspec.metricsconfig.ValueFrom valueFrom) {
