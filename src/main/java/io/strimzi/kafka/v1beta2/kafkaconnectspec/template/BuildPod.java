...
public class BuildPod implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Affinity affinity;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Affinity getAffinity() {
        return affinity;
    }

    public void setAffinity(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Affinity affinity) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.HostAliases> hostAliases;

    public java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.HostAliases> getHostAliases() {
        return hostAliases;
    }

    public void setHostAliases(java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.HostAliases> hostAliases) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.ImagePullSecrets> imagePullSecrets;

    public java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.ImagePullSecrets> getImagePullSecrets() {
        return imagePullSecrets;
    }

    public void setImagePullSecrets(java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.ImagePullSecrets> imagePullSecrets) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Metadata metadata;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Metadata metadata) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.SecurityContext securityContext;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.SecurityContext getSecurityContext() {
        return securityContext;
    }

    public void setSecurityContext(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.SecurityContext securityContext) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Tolerations> tolerations;

    public java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Tolerations> getTolerations() {
        return tolerations;
    }

    public void setTolerations(java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Tolerations> tolerations) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.TopologySpreadConstraints> topologySpreadConstraints;

    public java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.TopologySpreadConstraints> getTopologySpreadConstraints() {
        return topologySpreadConstraints;
    }

    public void setTopologySpreadConstraints(java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.TopologySpreadConstraints> topologySpreadConstraints) {
