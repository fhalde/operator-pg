...
public class Build implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.build.Output output;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.build.Output getOutput() {
        return output;
    }

    public void setOutput(io.strimzi.kafka.v1beta2.kafkaconnectspec.build.Output output) {
        this.output = output;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.build.Plugins> plugins;

    public java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.build.Plugins> getPlugins() {
        return plugins;
    }

    public void setPlugins(java.util.List<io.strimzi.kafka.v1beta2.kafkaconnectspec.build.Plugins> plugins) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.build.Resources resources;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.build.Resources getResources() {
        return resources;
    }

    public void setResources(io.strimzi.kafka.v1beta2.kafkaconnectspec.build.Resources resources) {
