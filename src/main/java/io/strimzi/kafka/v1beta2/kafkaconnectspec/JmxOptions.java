...
public class JmxOptions implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.strimzi.kafka.v1beta2.kafkaconnectspec.jmxoptions.Authentication authentication;

    public io.strimzi.kafka.v1beta2.kafkaconnectspec.jmxoptions.Authentication getAuthentication() {
        return authentication;
    }

    public void setAuthentication(io.strimzi.kafka.v1beta2.kafkaconnectspec.jmxoptions.Authentication authentication) {
