...
public class KafkaConnect extends io.fabric8.kubernetes.client.CustomResource<io.strimzi.kafka.v1beta2.KafkaConnectSpec, io.strimzi.kafka.v1beta2.KafkaConnectStatus> implements io.fabric8.kubernetes.api.model.Namespaced {
}
