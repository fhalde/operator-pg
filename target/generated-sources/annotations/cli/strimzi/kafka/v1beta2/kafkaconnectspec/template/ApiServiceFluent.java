...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.apiservice.MetadataBuilder;
import java.lang.SuppressWarnings;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.apiservice.MetadataFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.apiservice.Metadata;
...
public class ApiServiceFluent<A extends ApiServiceFluent<A>> extends BaseFluent<A>{
  ...
  public A addToIpFamilies(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.ApiService.IpFamilies... items) {
    if (this.ipFamilies == null) {this.ipFamilies = new ArrayList<ApiService.IpFamilies>();}
  ...
  public A removeFromIpFamilies(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.ApiService.IpFamilies... items) {
  ...
  public A withIpFamilies(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.ApiService.IpFamilies... ipFamilies) {
