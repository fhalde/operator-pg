package cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildserviceaccount;

import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildserviceaccount.metadata.LabelsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildserviceaccount.metadata.AnnotationsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildserviceaccount.metadata.Labels;
import java.lang.String;
import java.util.LinkedHashMap;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildserviceaccount.metadata.LabelsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildserviceaccount.metadata.Annotations;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildserviceaccount.metadata.AnnotationsBuilder;
...
public class MetadataFluent<A extends MetadataFluent<A>> extends BaseFluent<A>{
  ...
  public AnnotationsNested<A> editBuildserviceaccountAnnotations() {
  ...
  public LabelsNested<A> editBuildserviceaccountLabels() {
  ...
  public class AnnotationsNested<N> extends AnnotationsFluent<AnnotationsNested<N>> implements Nested<N>{
    ...
    public N endBuildserviceaccountAnnotations() {
      return and();
    }
  ...
  public class LabelsNested<N> extends LabelsFluent<LabelsNested<N>> implements Nested<N>{
    ...
    public N endBuildserviceaccountLabels() {
      return and();
    }
