package cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer;

import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.CapabilitiesFluent;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.SeccompProfile;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.SeccompProfileBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.SeLinuxOptionsBuilder;
import java.util.LinkedHashMap;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.CapabilitiesBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.SeLinuxOptions;
import java.lang.Boolean;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.WindowsOptionsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.WindowsOptionsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.SeLinuxOptionsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.WindowsOptions;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.Capabilities;
import java.lang.Long;
import java.lang.Object;
import java.util.Map;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.securitycontext.SeccompProfileFluent;
...
public class SecurityContextFluent<A extends SecurityContextFluent<A>> extends BaseFluent<A>{
  ...
  public CapabilitiesNested<A> editInitcontainerCapabilities() {
  ...
  public SeLinuxOptionsNested<A> editInitcontainerSeLinuxOptions() {
  ...
  public SeccompProfileNested<A> editInitcontainerSeccompProfile() {
  ...
  public WindowsOptionsNested<A> editInitcontainerWindowsOptions() {
  ...
  public class CapabilitiesNested<N> extends CapabilitiesFluent<CapabilitiesNested<N>> implements Nested<N>{
    ...
    public N endInitcontainerCapabilities() {
      return and();
    }
  ...
  public class SeLinuxOptionsNested<N> extends SeLinuxOptionsFluent<SeLinuxOptionsNested<N>> implements Nested<N>{
    ...
    public N endInitcontainerSeLinuxOptions() {
      return and();
    }
  ...
  public class SeccompProfileNested<N> extends SeccompProfileFluent<SeccompProfileNested<N>> implements Nested<N>{
    ...
    public N endInitcontainerSeccompProfile() {
      return and();
    }
  ...
  public class WindowsOptionsNested<N> extends WindowsOptionsFluent<WindowsOptionsNested<N>> implements Nested<N>{
    ...
    public N endInitcontainerWindowsOptions() {
      return and();
    }
