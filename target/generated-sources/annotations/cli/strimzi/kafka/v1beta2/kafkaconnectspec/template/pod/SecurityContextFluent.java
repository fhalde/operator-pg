...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.Sysctls;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeccompProfile;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeccompProfileBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeLinuxOptionsBuilder;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeLinuxOptions;
import java.util.List;
import java.lang.Boolean;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.WindowsOptionsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SysctlsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.WindowsOptionsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeLinuxOptionsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.WindowsOptions;
import java.lang.Long;
import java.util.Collection;
import java.lang.Object;
import java.util.Map;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeccompProfileFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SysctlsFluent;
...
public class SecurityContextFluent<A extends SecurityContextFluent<A>> extends BaseFluent<A>{
  ...
  public SeLinuxOptionsNested<A> editPodSeLinuxOptions() {
  ...
  public SeccompProfileNested<A> editPodSeccompProfile() {
  ...
  public A addToSysctls(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.Sysctls... items) {
    if (this.sysctls == null) {this.sysctls = new ArrayList<SysctlsBuilder>();}
  ...
  public A addAllToPodSysctls(Collection<Sysctls> items) {
    if (this.sysctls == null) {this.sysctls = new ArrayList<SysctlsBuilder>();}
    for (Sysctls item : items) {SysctlsBuilder builder = new SysctlsBuilder(item);_visitables.get("sysctls").add(builder);this.sysctls.add(builder);} return (A)this;
  }
  
  public A removeFromSysctls(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.Sysctls... items) {
  ...
  public A removeAllFromPodSysctls(Collection<Sysctls> items) {
    if (this.sysctls == null) return (A)this;
    for (Sysctls item : items) {SysctlsBuilder builder = new SysctlsBuilder(item);_visitables.get("sysctls").remove(builder); this.sysctls.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPodSysctls(Predicate<SysctlsBuilder> predicate) {
  ...
  public A withSysctls(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.Sysctls... sysctls) {
    if (this.sysctls != null) {
        this.sysctls.clear();
  ...
  public WindowsOptionsNested<A> editPodWindowsOptions() {
