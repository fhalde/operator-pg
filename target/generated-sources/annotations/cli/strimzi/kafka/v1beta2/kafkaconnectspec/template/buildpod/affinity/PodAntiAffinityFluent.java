...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.PreferredDuringSchedulingIgnoredDuringExecutionBuilder;
import io.fabric8.kubernetes.api.builder.VisitableBuilder;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.RequiredDuringSchedulingIgnoredDuringExecutionFluent;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.PreferredDuringSchedulingIgnoredDuringExecution;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.RequiredDuringSchedulingIgnoredDuringExecution;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.RequiredDuringSchedulingIgnoredDuringExecutionBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.PreferredDuringSchedulingIgnoredDuringExecutionFluent;
...
public class PodAntiAffinityFluent<A extends PodAntiAffinityFluent<A>> extends BaseFluent<A>{
  ...
  public A addToPreferredDuringSchedulingIgnoredDuringExecution(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.PreferredDuringSchedulingIgnoredDuringExecution... items) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution == null) {this.preferredDuringSchedulingIgnoredDuringExecution = new ArrayList<PreferredDuringSchedulingIgnoredDuringExecutionBuilder>();}
  ...
  public A addAllToPodantiaffinityPreferredDuringSchedulingIgnoredDuringExecution(Collection<PreferredDuringSchedulingIgnoredDuringExecution> items) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution == null) {this.preferredDuringSchedulingIgnoredDuringExecution = new ArrayList<PreferredDuringSchedulingIgnoredDuringExecutionBuilder>();}
    for (PreferredDuringSchedulingIgnoredDuringExecution item : items) {PreferredDuringSchedulingIgnoredDuringExecutionBuilder builder = new PreferredDuringSchedulingIgnoredDuringExecutionBuilder(item);_visitables.get("preferredDuringSchedulingIgnoredDuringExecution").add(builder);this.preferredDuringSchedulingIgnoredDuringExecution.add(builder);} return (A)this;
  }
  
  public A removeFromPreferredDuringSchedulingIgnoredDuringExecution(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.PreferredDuringSchedulingIgnoredDuringExecution... items) {
  ...
  public A removeAllFromPodantiaffinityPreferredDuringSchedulingIgnoredDuringExecution(Collection<PreferredDuringSchedulingIgnoredDuringExecution> items) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution == null) return (A)this;
    for (PreferredDuringSchedulingIgnoredDuringExecution item : items) {PreferredDuringSchedulingIgnoredDuringExecutionBuilder builder = new PreferredDuringSchedulingIgnoredDuringExecutionBuilder(item);_visitables.get("preferredDuringSchedulingIgnoredDuringExecution").remove(builder); this.preferredDuringSchedulingIgnoredDuringExecution.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPodantiaffinityPreferredDuringSchedulingIgnoredDuringExecution(Predicate<PreferredDuringSchedulingIgnoredDuringExecutionBuilder> predicate) {
  ...
  public A withPreferredDuringSchedulingIgnoredDuringExecution(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.PreferredDuringSchedulingIgnoredDuringExecution... preferredDuringSchedulingIgnoredDuringExecution) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution != null) {
  ...
  public A addToRequiredDuringSchedulingIgnoredDuringExecution(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.RequiredDuringSchedulingIgnoredDuringExecution... items) {
    if (this.requiredDuringSchedulingIgnoredDuringExecution == null) {this.requiredDuringSchedulingIgnoredDuringExecution = new ArrayList<RequiredDuringSchedulingIgnoredDuringExecutionBuilder>();}
  ...
  public A addAllToPodantiaffinityRequiredDuringSchedulingIgnoredDuringExecution(Collection<RequiredDuringSchedulingIgnoredDuringExecution> items) {
    if (this.requiredDuringSchedulingIgnoredDuringExecution == null) {this.requiredDuringSchedulingIgnoredDuringExecution = new ArrayList<RequiredDuringSchedulingIgnoredDuringExecutionBuilder>();}
    for (RequiredDuringSchedulingIgnoredDuringExecution item : items) {RequiredDuringSchedulingIgnoredDuringExecutionBuilder builder = new RequiredDuringSchedulingIgnoredDuringExecutionBuilder(item);_visitables.get("requiredDuringSchedulingIgnoredDuringExecution").add(builder);this.requiredDuringSchedulingIgnoredDuringExecution.add(builder);} return (A)this;
  }
  
  public A removeFromRequiredDuringSchedulingIgnoredDuringExecution(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.RequiredDuringSchedulingIgnoredDuringExecution... items) {
  ...
  public A removeAllFromPodantiaffinityRequiredDuringSchedulingIgnoredDuringExecution(Collection<RequiredDuringSchedulingIgnoredDuringExecution> items) {
    if (this.requiredDuringSchedulingIgnoredDuringExecution == null) return (A)this;
    for (RequiredDuringSchedulingIgnoredDuringExecution item : items) {RequiredDuringSchedulingIgnoredDuringExecutionBuilder builder = new RequiredDuringSchedulingIgnoredDuringExecutionBuilder(item);_visitables.get("requiredDuringSchedulingIgnoredDuringExecution").remove(builder); this.requiredDuringSchedulingIgnoredDuringExecution.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPodantiaffinityRequiredDuringSchedulingIgnoredDuringExecution(Predicate<RequiredDuringSchedulingIgnoredDuringExecutionBuilder> predicate) {
  ...
  public A withRequiredDuringSchedulingIgnoredDuringExecution(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.RequiredDuringSchedulingIgnoredDuringExecution... requiredDuringSchedulingIgnoredDuringExecution) {
    if (this.requiredDuringSchedulingIgnoredDuringExecution != null) {
  ...
  public class PreferredDuringSchedulingIgnoredDuringExecutionNested<N> extends PreferredDuringSchedulingIgnoredDuringExecutionFluent<PreferredDuringSchedulingIgnoredDuringExecutionNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodAntiAffinityFluent.this.setToPreferredDuringSchedulingIgnoredDuringExecution(index,builder.build());
    }
    
    public N endPodantiaffinityPreferredDuringSchedulingIgnoredDuringExecution() {
      return and();
    }
  ...
  public class RequiredDuringSchedulingIgnoredDuringExecutionNested<N> extends RequiredDuringSchedulingIgnoredDuringExecutionFluent<RequiredDuringSchedulingIgnoredDuringExecutionNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodAntiAffinityFluent.this.setToRequiredDuringSchedulingIgnoredDuringExecution(index,builder.build());
    }
    
    public N endPodantiaffinityRequiredDuringSchedulingIgnoredDuringExecution() {
      return and();
    }
