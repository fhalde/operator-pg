...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.LimitsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Requests;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.ClaimsBuilder;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Limits;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.ClaimsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.RequestsFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Claims;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.LimitsBuilder;
import java.util.Collection;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.RequestsBuilder;
...
public class ResourcesFluent<A extends ResourcesFluent<A>> extends BaseFluent<A>{
  ...
  public A addToClaims(cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Claims... items) {
    if (this.claims == null) {this.claims = new ArrayList<ClaimsBuilder>();}
  ...
  public A addAllToKafkaconnectspecClaims(Collection<Claims> items) {
    if (this.claims == null) {this.claims = new ArrayList<ClaimsBuilder>();}
    for (Claims item : items) {ClaimsBuilder builder = new ClaimsBuilder(item);_visitables.get("claims").add(builder);this.claims.add(builder);} return (A)this;
  }
  
  public A removeFromClaims(cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Claims... items) {
  ...
  public A removeAllFromKafkaconnectspecClaims(Collection<Claims> items) {
    if (this.claims == null) return (A)this;
    for (Claims item : items) {ClaimsBuilder builder = new ClaimsBuilder(item);_visitables.get("claims").remove(builder); this.claims.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromKafkaconnectspecClaims(Predicate<ClaimsBuilder> predicate) {
  ...
  public A withClaims(cli.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Claims... claims) {
    if (this.claims != null) {
        this.claims.clear();
  ...
  public LimitsNested<A> editKafkaconnectspecLimits() {
  ...
  public RequestsNested<A> editKafkaconnectspecRequests() {
  ...
  public class ClaimsNested<N> extends ClaimsFluent<ClaimsNested<N>> implements Nested<N>{
    ...
    public N endKafkaconnectspecClaim() {
      return and();
    }
  ...
  public class LimitsNested<N> extends LimitsFluent<LimitsNested<N>> implements Nested<N>{
    ...
    public N endKafkaconnectspecLimits() {
      return and();
    }
  ...
  public class RequestsNested<N> extends RequestsFluent<RequestsNested<N>> implements Nested<N>{
    ...
    public N endKafkaconnectspecRequests() {
      return and();
    }
