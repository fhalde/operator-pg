...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.configmap.ItemsBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Long;
import java.util.Iterator;
import java.util.Collection;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.configmap.Items;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.configmap.ItemsFluent;
...
public class ConfigMapFluent<A extends ConfigMapFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.configmap.Items... items) {
    if (this.items == null) {this.items = new ArrayList<ItemsBuilder>();}
  ...
  public A removeFromItems(cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.configmap.Items... items) {
  ...
  public A withItems(cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.configmap.Items... items) {
    if (this.items != null) {
        this.items.clear();
