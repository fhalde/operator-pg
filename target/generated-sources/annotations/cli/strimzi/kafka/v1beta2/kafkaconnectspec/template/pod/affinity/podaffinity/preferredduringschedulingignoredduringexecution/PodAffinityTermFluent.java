package cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.podaffinity.preferredduringschedulingignoredduringexecution;

import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.LabelSelectorBuilder;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.LabelSelector;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.NamespaceSelector;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.NamespaceSelectorBuilder;
import java.util.Collection;
import java.lang.Object;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.LabelSelectorFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.NamespaceSelectorFluent;
...
public class PodAffinityTermFluent<A extends PodAffinityTermFluent<A>> extends BaseFluent<A>{
  ...
  public LabelSelectorNested<A> editPodLabelSelector() {
  ...
  public NamespaceSelectorNested<A> editPodNamespaceSelector() {
  ...
  public class NamespaceSelectorNested<N> extends NamespaceSelectorFluent<NamespaceSelectorNested<N>> implements Nested<N>{
    ...
    public N endPodNamespaceSelector() {
      return and();
    }
