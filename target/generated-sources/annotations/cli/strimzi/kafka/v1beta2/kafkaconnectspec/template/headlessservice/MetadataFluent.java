package cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.headlessservice;

import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.headlessservice.metadata.LabelsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.headlessservice.metadata.AnnotationsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.headlessservice.metadata.Labels;
import java.lang.String;
import java.util.LinkedHashMap;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.headlessservice.metadata.LabelsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.headlessservice.metadata.Annotations;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.headlessservice.metadata.AnnotationsBuilder;
...
public class MetadataFluent<A extends MetadataFluent<A>> extends BaseFluent<A>{
  ...
  public AnnotationsNested<A> editHeadlessserviceAnnotations() {
  ...
  public LabelsNested<A> editHeadlessserviceLabels() {
  ...
  public class AnnotationsNested<N> extends AnnotationsFluent<AnnotationsNested<N>> implements Nested<N>{
    ...
    public N endHeadlessserviceAnnotations() {
      return and();
    }
  ...
  public class LabelsNested<N> extends LabelsFluent<LabelsNested<N>> implements Nested<N>{
    ...
    public N endHeadlessserviceLabels() {
      return and();
    }
