...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.Env;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.SecurityContextBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.EnvFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.EnvBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.SecurityContext;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.SecurityContextFluent;
...
public class ConnectContainerFluent<A extends ConnectContainerFluent<A>> extends BaseFluent<A>{
  ...
  public A addToEnv(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.Env... items) {
    if (this.env == null) {this.env = new ArrayList<EnvBuilder>();}
  ...
  public A removeFromEnv(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.Env... items) {
  ...
  public A withEnv(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.Env... env) {
    if (this.env != null) {
        this.env.clear();
