...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.metadata.LabelsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.metadata.AnnotationsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.metadata.Labels;
import java.lang.String;
import java.util.LinkedHashMap;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.metadata.LabelsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.metadata.Annotations;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.metadata.AnnotationsBuilder;
...
public class MetadataFluent<A extends MetadataFluent<A>> extends BaseFluent<A>{
  ...
  public AnnotationsNested<A> editBuildpodAnnotations() {
  ...
  public LabelsNested<A> editBuildpodLabels() {
  ...
  public class AnnotationsNested<N> extends AnnotationsFluent<AnnotationsNested<N>> implements Nested<N>{
    ...
    public N endBuildpodAnnotations() {
      return and();
    }
