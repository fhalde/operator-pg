...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.deployment.MetadataBuilder;
import java.lang.SuppressWarnings;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.deployment.MetadataFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.deployment.Metadata;
...
public class DeploymentFluent<A extends DeploymentFluent<A>> extends BaseFluent<A>{
  ...
  private Deployment.DeploymentStrategy deploymentStrategy;
  ...
  public Deployment.DeploymentStrategy getDeploymentStrategy() {
    return this.deploymentStrategy;
  }
  
  public A withDeploymentStrategy(Deployment.DeploymentStrategy deploymentStrategy) {
  ...
  public MetadataNested<A> editDeploymentMetadata() {
  ...
  public int hashCode() {
    return java.util.Objects.hash(deploymentStrategy,  metadata,  additionalProperties,  super.hashCode());
  }
  ...
  public class MetadataNested<N> extends MetadataFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N endDeploymentMetadata() {
      return and();
    }
