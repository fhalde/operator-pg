...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.PodAffinityTermBuilder;
import java.lang.String;
import java.util.LinkedHashMap;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.PodAffinityTerm;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.PodAffinityTermFluent;
...
public class PreferredDuringSchedulingIgnoredDuringExecutionFluent<A extends PreferredDuringSchedulingIgnoredDuringExecutionFluent<A>> extends BaseFluent<A>{
  ...
  public PodAffinityTermNested<A> editPodPodAffinityTerm() {
  ...
  public class PodAffinityTermNested<N> extends PodAffinityTermFluent<PodAffinityTermNested<N>> implements Nested<N>{
    ...
    public N endPodPodAffinityTerm() {
      return and();
    }
