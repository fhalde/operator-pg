package cli.strimzi.kafka.v1beta2.kafkaconnectspec.logging;

import cli.strimzi.kafka.v1beta2.kafkaconnectspec.logging.valuefrom.ConfigMapKeyRef;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.logging.valuefrom.ConfigMapKeyRefBuilder;
import java.lang.String;
import java.util.LinkedHashMap;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.logging.valuefrom.ConfigMapKeyRefFluent;
...
public class ValueFromFluent<A extends ValueFromFluent<A>> extends BaseFluent<A>{
  ...
  public ConfigMapKeyRefNested<A> editLoggingConfigMapKeyRef() {
  ...
  public class ConfigMapKeyRefNested<N> extends ConfigMapKeyRefFluent<ConfigMapKeyRefNested<N>> implements Nested<N>{
    ...
    public N endLoggingConfigMapKeyRef() {
      return and();
    }
