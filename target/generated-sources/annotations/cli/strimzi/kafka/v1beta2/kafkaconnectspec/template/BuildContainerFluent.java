...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.Env;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.SecurityContextBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.EnvFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.EnvBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.SecurityContext;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.SecurityContextFluent;
...
public class BuildContainerFluent<A extends BuildContainerFluent<A>> extends BaseFluent<A>{
  ...
  public A addToEnv(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.Env... items) {
    if (this.env == null) {this.env = new ArrayList<EnvBuilder>();}
  ...
  public A removeFromEnv(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.Env... items) {
  ...
  public A withEnv(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.Env... env) {
    if (this.env != null) {
        this.env.clear();
