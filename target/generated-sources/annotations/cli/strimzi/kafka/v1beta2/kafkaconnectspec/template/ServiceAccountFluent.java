...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.MetadataBuilder;
import java.lang.SuppressWarnings;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.MetadataFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.Metadata;
...
public class ServiceAccountFluent<A extends ServiceAccountFluent<A>> extends BaseFluent<A>{
  ...
  public MetadataNested<A> editServiceaccountMetadata() {
  ...
  public class MetadataNested<N> extends MetadataFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N endServiceaccountMetadata() {
      return and();
    }
