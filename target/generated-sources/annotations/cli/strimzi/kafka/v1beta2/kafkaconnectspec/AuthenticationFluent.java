...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.CertificateAndKeyBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.RefreshTokenFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.TlsTrustedCertificatesBuilder;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.AccessTokenBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.PasswordSecretFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.RefreshToken;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.AccessToken;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.ClientSecretFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.TlsTrustedCertificatesFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import java.lang.Boolean;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.CertificateAndKeyFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.PasswordSecret;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.RefreshTokenBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.PasswordSecretBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.TlsTrustedCertificates;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.ClientSecret;
import java.lang.Long;
import java.util.Collection;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.AccessTokenFluent;
import java.lang.Object;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.CertificateAndKey;
import java.util.Map;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.ClientSecretBuilder;
...
public class AuthenticationFluent<A extends AuthenticationFluent<A>> extends BaseFluent<A>{
  ...
  public A addToTlsTrustedCertificates(cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.TlsTrustedCertificates... items) {
    if (this.tlsTrustedCertificates == null) {this.tlsTrustedCertificates = new ArrayList<TlsTrustedCertificatesBuilder>();}
  ...
  public A addAllToTlsTrustedCertificates(Collection<TlsTrustedCertificates> items) {
    if (this.tlsTrustedCertificates == null) {this.tlsTrustedCertificates = new ArrayList<TlsTrustedCertificatesBuilder>();}
    for (TlsTrustedCertificates item : items) {TlsTrustedCertificatesBuilder builder = new TlsTrustedCertificatesBuilder(item);_visitables.get("tlsTrustedCertificates").add(builder);this.tlsTrustedCertificates.add(builder);} return (A)this;
  }
  
  public A removeFromTlsTrustedCertificates(cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.TlsTrustedCertificates... items) {
  ...
  public A removeAllFromTlsTrustedCertificates(Collection<TlsTrustedCertificates> items) {
    if (this.tlsTrustedCertificates == null) return (A)this;
    for (TlsTrustedCertificates item : items) {TlsTrustedCertificatesBuilder builder = new TlsTrustedCertificatesBuilder(item);_visitables.get("tlsTrustedCertificates").remove(builder); this.tlsTrustedCertificates.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromTlsTrustedCertificates(Predicate<TlsTrustedCertificatesBuilder> predicate) {
  ...
  public A withTlsTrustedCertificates(cli.strimzi.kafka.v1beta2.kafkaconnectspec.authentication.TlsTrustedCertificates... tlsTrustedCertificates) {
    if (this.tlsTrustedCertificates != null) {
