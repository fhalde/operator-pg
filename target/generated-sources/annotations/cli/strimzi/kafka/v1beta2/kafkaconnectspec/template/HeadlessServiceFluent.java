...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.headlessservice.MetadataBuilder;
import java.lang.SuppressWarnings;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.headlessservice.MetadataFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.headlessservice.Metadata;
...
public class HeadlessServiceFluent<A extends HeadlessServiceFluent<A>> extends BaseFluent<A>{
  ...
  public A addToIpFamilies(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.HeadlessService.IpFamilies... items) {
    if (this.ipFamilies == null) {this.ipFamilies = new ArrayList<HeadlessService.IpFamilies>();}
  ...
  public A removeFromIpFamilies(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.HeadlessService.IpFamilies... items) {
  ...
  public A withIpFamilies(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.HeadlessService.IpFamilies... ipFamilies) {
