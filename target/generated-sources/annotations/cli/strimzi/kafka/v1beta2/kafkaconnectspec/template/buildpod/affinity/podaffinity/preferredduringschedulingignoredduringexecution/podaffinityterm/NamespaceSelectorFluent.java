...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressionsBuilder;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressions;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchLabelsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressionsFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchLabels;
import java.util.Collection;
import java.lang.Object;
import java.util.Map;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchLabelsBuilder;
...
public class NamespaceSelectorFluent<A extends NamespaceSelectorFluent<A>> extends BaseFluent<A>{
  ...
  public A addToMatchExpressions(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressions... items) {
    if (this.matchExpressions == null) {this.matchExpressions = new ArrayList<MatchExpressionsBuilder>();}
  ...
  public A removeFromMatchExpressions(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressions... items) {
  ...
  public A withMatchExpressions(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.preferredduringschedulingignoredduringexecution.podaffinityterm.namespaceselector.MatchExpressions... matchExpressions) {
    if (this.matchExpressions != null) {
