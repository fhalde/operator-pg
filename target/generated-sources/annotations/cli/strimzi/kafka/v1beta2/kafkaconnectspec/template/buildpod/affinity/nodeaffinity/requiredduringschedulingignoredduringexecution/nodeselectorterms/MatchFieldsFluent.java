package cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms;
...
public class MatchFieldsFluent<A extends MatchFieldsFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(MatchFields instance) {
    instance = (instance != null ? instance : new MatchFields());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    MatchFieldsFluent that = (MatchFieldsFluent) o;
