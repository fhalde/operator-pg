...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecutionBuilder;
import io.fabric8.kubernetes.api.builder.VisitableBuilder;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.RequiredDuringSchedulingIgnoredDuringExecutionFluent;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecution;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.RequiredDuringSchedulingIgnoredDuringExecution;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.RequiredDuringSchedulingIgnoredDuringExecutionBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecutionFluent;
...
public class NodeAffinityFluent<A extends NodeAffinityFluent<A>> extends BaseFluent<A>{
  ...
  public A addToPreferredDuringSchedulingIgnoredDuringExecution(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecution... items) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution == null) {this.preferredDuringSchedulingIgnoredDuringExecution = new ArrayList<PreferredDuringSchedulingIgnoredDuringExecutionBuilder>();}
  ...
  public A removeFromPreferredDuringSchedulingIgnoredDuringExecution(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecution... items) {
  ...
  public A withPreferredDuringSchedulingIgnoredDuringExecution(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecution... preferredDuringSchedulingIgnoredDuringExecution) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution != null) {
