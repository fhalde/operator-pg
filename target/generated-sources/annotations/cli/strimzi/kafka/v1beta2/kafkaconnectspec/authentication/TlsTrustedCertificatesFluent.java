...
public class TlsTrustedCertificatesFluent<A extends TlsTrustedCertificatesFluent<A>> extends BaseFluent<A>{
  public TlsTrustedCertificatesFluent() {
  }
  
  public TlsTrustedCertificatesFluent(TlsTrustedCertificates instance) {
  ...
  protected void copyInstance(TlsTrustedCertificates instance) {
    instance = (instance != null ? instance : new TlsTrustedCertificates());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    TlsTrustedCertificatesFluent that = (TlsTrustedCertificatesFluent) o;
