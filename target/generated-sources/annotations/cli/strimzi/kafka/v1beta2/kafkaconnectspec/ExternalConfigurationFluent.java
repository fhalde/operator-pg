...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.Env;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.Volumes;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.VolumesBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.EnvFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.VolumesFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.EnvBuilder;
...
public class ExternalConfigurationFluent<A extends ExternalConfigurationFluent<A>> extends BaseFluent<A>{
  ...
  public A addToEnv(cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.Env... items) {
    if (this.env == null) {this.env = new ArrayList<EnvBuilder>();}
  ...
  public A removeFromEnv(cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.Env... items) {
  ...
  public A withEnv(cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.Env... env) {
    if (this.env != null) {
        this.env.clear();
  ...
  public A addToVolumes(cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.Volumes... items) {
    if (this.volumes == null) {this.volumes = new ArrayList<VolumesBuilder>();}
  ...
  public A removeFromVolumes(cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.Volumes... items) {
  ...
  public A withVolumes(cli.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.Volumes... volumes) {
    if (this.volumes != null) {
        this.volumes.clear();
