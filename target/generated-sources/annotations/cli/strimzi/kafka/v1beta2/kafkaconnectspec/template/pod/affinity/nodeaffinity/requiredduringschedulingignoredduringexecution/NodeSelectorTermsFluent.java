package cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution;

import io.fabric8.kubernetes.api.builder.VisitableBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressionsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFieldsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressions;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressionsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFields;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFieldsBuilder;
...
public class NodeSelectorTermsFluent<A extends NodeSelectorTermsFluent<A>> extends BaseFluent<A>{
  ...
  public A addToMatchExpressions(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressions... items) {
    if (this.matchExpressions == null) {this.matchExpressions = new ArrayList<MatchExpressionsBuilder>();}
  ...
  public A removeFromMatchExpressions(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressions... items) {
  ...
  public A withMatchExpressions(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressions... matchExpressions) {
    if (this.matchExpressions != null) {
  ...
  public A addToMatchFields(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFields... items) {
    if (this.matchFields == null) {this.matchFields = new ArrayList<MatchFieldsBuilder>();}
  ...
  public A removeFromMatchFields(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFields... items) {
  ...
  public A withMatchFields(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFields... matchFields) {
    if (this.matchFields != null) {
