...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.PluginsBuilder;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.Output;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.OutputBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.ResourcesBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.Plugins;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.PluginsFluent;
import java.util.Collection;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.OutputFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.ResourcesFluent;
import java.lang.Object;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.Resources;
...
public class BuildFluent<A extends BuildFluent<A>> extends BaseFluent<A>{
  ...
  public A addToPlugins(cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.Plugins... items) {
    if (this.plugins == null) {this.plugins = new ArrayList<PluginsBuilder>();}
  ...
  public A addAllToPlugins(Collection<Plugins> items) {
    if (this.plugins == null) {this.plugins = new ArrayList<PluginsBuilder>();}
    for (Plugins item : items) {PluginsBuilder builder = new PluginsBuilder(item);_visitables.get("plugins").add(builder);this.plugins.add(builder);} return (A)this;
  }
  
  public A removeFromPlugins(cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.Plugins... items) {
  ...
  public A removeAllFromPlugins(Collection<Plugins> items) {
    if (this.plugins == null) return (A)this;
    for (Plugins item : items) {PluginsBuilder builder = new PluginsBuilder(item);_visitables.get("plugins").remove(builder); this.plugins.remove(builder);} return (A)this;
  }
  ...
  public A withPlugins(cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.Plugins... plugins) {
    if (this.plugins != null) {
        this.plugins.clear();
