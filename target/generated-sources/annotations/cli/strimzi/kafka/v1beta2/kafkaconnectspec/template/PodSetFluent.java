...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.podset.MetadataBuilder;
import java.lang.SuppressWarnings;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.podset.MetadataFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.podset.Metadata;
...
public class PodSetFluent<A extends PodSetFluent<A>> extends BaseFluent<A>{
  public PodSetFluent() {
  }
  
  public PodSetFluent(PodSet instance) {
    this.copyInstance(instance);
  }
  private MetadataBuilder metadata;
  private Map<String,Object> additionalProperties;
  
  protected void copyInstance(PodSet instance) {
    instance = (instance != null ? instance : new PodSet());
    if (instance != null) {
  ...
  public MetadataNested<A> editPodsetMetadata() {
  ...
  public boolean equals(Object o) {
    ...
    PodSetFluent that = (PodSetFluent) o;
  ...
  public class MetadataNested<N> extends MetadataFluent<MetadataNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodSetFluent.this.withMetadata(builder.build());
    }
    
    public N endPodsetMetadata() {
      return and();
    }
