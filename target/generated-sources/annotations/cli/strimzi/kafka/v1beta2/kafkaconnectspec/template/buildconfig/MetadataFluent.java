package cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildconfig;

import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildconfig.metadata.LabelsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildconfig.metadata.AnnotationsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildconfig.metadata.Labels;
import java.lang.String;
import java.util.LinkedHashMap;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildconfig.metadata.LabelsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildconfig.metadata.Annotations;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildconfig.metadata.AnnotationsBuilder;
...
public class MetadataFluent<A extends MetadataFluent<A>> extends BaseFluent<A>{
  ...
  public AnnotationsNested<A> editBuildconfigAnnotations() {
  ...
  public LabelsNested<A> editBuildconfigLabels() {
  ...
  public class AnnotationsNested<N> extends AnnotationsFluent<AnnotationsNested<N>> implements Nested<N>{
    ...
    public N endBuildconfigAnnotations() {
      return and();
    }
