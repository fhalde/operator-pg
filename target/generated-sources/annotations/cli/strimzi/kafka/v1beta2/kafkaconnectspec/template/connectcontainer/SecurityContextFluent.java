...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.CapabilitiesFluent;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.SeccompProfile;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.SeccompProfileBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.SeLinuxOptionsBuilder;
import java.util.LinkedHashMap;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.CapabilitiesBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.SeLinuxOptions;
import java.lang.Boolean;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.WindowsOptionsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.WindowsOptionsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.SeLinuxOptionsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.WindowsOptions;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.Capabilities;
import java.lang.Long;
import java.lang.Object;
import java.util.Map;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.connectcontainer.securitycontext.SeccompProfileFluent;
...
public class SecurityContextFluent<A extends SecurityContextFluent<A>> extends BaseFluent<A>{
  ...
  public CapabilitiesNested<A> editConnectcontainerCapabilities() {
  ...
  public SeLinuxOptionsNested<A> editConnectcontainerSeLinuxOptions() {
  ...
  public SeccompProfileNested<A> editConnectcontainerSeccompProfile() {
  ...
  public WindowsOptionsNested<A> editConnectcontainerWindowsOptions() {
  ...
  public class CapabilitiesNested<N> extends CapabilitiesFluent<CapabilitiesNested<N>> implements Nested<N>{
    ...
    public N endConnectcontainerCapabilities() {
      return and();
    }
  ...
  public class SeLinuxOptionsNested<N> extends SeLinuxOptionsFluent<SeLinuxOptionsNested<N>> implements Nested<N>{
    ...
    public N endConnectcontainerSeLinuxOptions() {
      return and();
    }
  ...
  public class SeccompProfileNested<N> extends SeccompProfileFluent<SeccompProfileNested<N>> implements Nested<N>{
    ...
    public N endConnectcontainerSeccompProfile() {
      return and();
    }
  ...
  public class WindowsOptionsNested<N> extends WindowsOptionsFluent<WindowsOptionsNested<N>> implements Nested<N>{
    ...
    public N endConnectcontainerWindowsOptions() {
      return and();
    }
