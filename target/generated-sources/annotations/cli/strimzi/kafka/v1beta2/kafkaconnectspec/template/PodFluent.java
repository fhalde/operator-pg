...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Tolerations;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TolerationsBuilder;
import java.util.ArrayList;
import java.lang.String;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.SecurityContextBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TolerationsFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.List;
import java.lang.Boolean;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecretsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliases;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.AffinityFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.SecurityContextFluent;
import java.lang.Long;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Affinity;
import java.util.Collection;
import java.lang.Object;
import java.util.Map;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraintsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.AffinityBuilder;
import java.lang.SuppressWarnings;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.MetadataFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraints;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Metadata;
import io.fabric8.kubernetes.api.builder.Nested;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraintsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliasesFluent;
import java.util.Iterator;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.MetadataBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecrets;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecretsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.SecurityContext;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliasesBuilder;
...
public class PodFluent<A extends PodFluent<A>> extends BaseFluent<A>{
  ...
  public AffinityNested<A> editPodAffinity() {
  ...
  public A addToHostAliases(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliases... items) {
    if (this.hostAliases == null) {this.hostAliases = new ArrayList<HostAliasesBuilder>();}
  ...
  public A addAllToPodHostAliases(Collection<HostAliases> items) {
    if (this.hostAliases == null) {this.hostAliases = new ArrayList<HostAliasesBuilder>();}
    for (HostAliases item : items) {HostAliasesBuilder builder = new HostAliasesBuilder(item);_visitables.get("hostAliases").add(builder);this.hostAliases.add(builder);} return (A)this;
  }
  
  public A removeFromHostAliases(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliases... items) {
  ...
  public A removeAllFromPodHostAliases(Collection<HostAliases> items) {
    if (this.hostAliases == null) return (A)this;
    for (HostAliases item : items) {HostAliasesBuilder builder = new HostAliasesBuilder(item);_visitables.get("hostAliases").remove(builder); this.hostAliases.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPodHostAliases(Predicate<HostAliasesBuilder> predicate) {
  ...
  public A withHostAliases(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliases... hostAliases) {
    if (this.hostAliases != null) {
  ...
  public A addToImagePullSecrets(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecrets... items) {
    if (this.imagePullSecrets == null) {this.imagePullSecrets = new ArrayList<ImagePullSecretsBuilder>();}
  ...
  public A addAllToPodImagePullSecrets(Collection<ImagePullSecrets> items) {
    if (this.imagePullSecrets == null) {this.imagePullSecrets = new ArrayList<ImagePullSecretsBuilder>();}
    for (ImagePullSecrets item : items) {ImagePullSecretsBuilder builder = new ImagePullSecretsBuilder(item);_visitables.get("imagePullSecrets").add(builder);this.imagePullSecrets.add(builder);} return (A)this;
  }
  
  public A removeFromImagePullSecrets(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecrets... items) {
  ...
  public A removeAllFromPodImagePullSecrets(Collection<ImagePullSecrets> items) {
    if (this.imagePullSecrets == null) return (A)this;
    for (ImagePullSecrets item : items) {ImagePullSecretsBuilder builder = new ImagePullSecretsBuilder(item);_visitables.get("imagePullSecrets").remove(builder); this.imagePullSecrets.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPodImagePullSecrets(Predicate<ImagePullSecretsBuilder> predicate) {
  ...
  public A withImagePullSecrets(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecrets... imagePullSecrets) {
    if (this.imagePullSecrets != null) {
  ...
  public MetadataNested<A> editPodMetadata() {
  ...
  public SecurityContextNested<A> editPodSecurityContext() {
  ...
  public A addToTolerations(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Tolerations... items) {
    if (this.tolerations == null) {this.tolerations = new ArrayList<TolerationsBuilder>();}
  ...
  public A addAllToPodTolerations(Collection<Tolerations> items) {
    if (this.tolerations == null) {this.tolerations = new ArrayList<TolerationsBuilder>();}
    for (Tolerations item : items) {TolerationsBuilder builder = new TolerationsBuilder(item);_visitables.get("tolerations").add(builder);this.tolerations.add(builder);} return (A)this;
  }
  
  public A removeFromTolerations(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Tolerations... items) {
  ...
  public A removeAllFromPodTolerations(Collection<Tolerations> items) {
    if (this.tolerations == null) return (A)this;
    for (Tolerations item : items) {TolerationsBuilder builder = new TolerationsBuilder(item);_visitables.get("tolerations").remove(builder); this.tolerations.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPodTolerations(Predicate<TolerationsBuilder> predicate) {
  ...
  public A withTolerations(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Tolerations... tolerations) {
    if (this.tolerations != null) {
  ...
  public A addToTopologySpreadConstraints(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraints... items) {
    if (this.topologySpreadConstraints == null) {this.topologySpreadConstraints = new ArrayList<TopologySpreadConstraintsBuilder>();}
  ...
  public A addAllToPodTopologySpreadConstraints(Collection<TopologySpreadConstraints> items) {
    if (this.topologySpreadConstraints == null) {this.topologySpreadConstraints = new ArrayList<TopologySpreadConstraintsBuilder>();}
    for (TopologySpreadConstraints item : items) {TopologySpreadConstraintsBuilder builder = new TopologySpreadConstraintsBuilder(item);_visitables.get("topologySpreadConstraints").add(builder);this.topologySpreadConstraints.add(builder);} return (A)this;
  }
  
  public A removeFromTopologySpreadConstraints(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraints... items) {
  ...
  public A removeAllFromPodTopologySpreadConstraints(Collection<TopologySpreadConstraints> items) {
    if (this.topologySpreadConstraints == null) return (A)this;
    for (TopologySpreadConstraints item : items) {TopologySpreadConstraintsBuilder builder = new TopologySpreadConstraintsBuilder(item);_visitables.get("topologySpreadConstraints").remove(builder); this.topologySpreadConstraints.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPodTopologySpreadConstraints(Predicate<TopologySpreadConstraintsBuilder> predicate) {
  ...
  public A withTopologySpreadConstraints(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraints... topologySpreadConstraints) {
    if (this.topologySpreadConstraints != null) {
  ...
  public class AffinityNested<N> extends AffinityFluent<AffinityNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodFluent.this.withAffinity(builder.build());
    }
  ...
  public class HostAliasesNested<N> extends HostAliasesFluent<HostAliasesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodFluent.this.setToHostAliases(index,builder.build());
    }
    
    public N endPodHostAlias() {
      return and();
    }
  ...
  public class ImagePullSecretsNested<N> extends ImagePullSecretsFluent<ImagePullSecretsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodFluent.this.setToImagePullSecrets(index,builder.build());
    }
    
    public N endPodImagePullSecret() {
      return and();
    }
  ...
  public class SecurityContextNested<N> extends SecurityContextFluent<SecurityContextNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodFluent.this.withSecurityContext(builder.build());
    }
    
    public N endPodSecurityContext() {
      return and();
    }
  ...
  public class TolerationsNested<N> extends TolerationsFluent<TolerationsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodFluent.this.setToTolerations(index,builder.build());
    }
    
    public N endPodToleration() {
      return and();
    }
  ...
  public class TopologySpreadConstraintsNested<N> extends TopologySpreadConstraintsFluent<TopologySpreadConstraintsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PodFluent.this.setToTopologySpreadConstraints(index,builder.build());
    }
    
    public N endPodTopologySpreadConstraint() {
      return and();
    }
