package cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution;

import io.fabric8.kubernetes.api.builder.VisitableBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchExpressionsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchFieldsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchExpressions;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchExpressionsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchFields;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchFieldsBuilder;
...
public class PreferenceFluent<A extends PreferenceFluent<A>> extends BaseFluent<A>{
  ...
  public A addToMatchExpressions(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchExpressions... items) {
    if (this.matchExpressions == null) {this.matchExpressions = new ArrayList<MatchExpressionsBuilder>();}
  ...
  public A addAllToPodMatchExpressions(Collection<MatchExpressions> items) {
    if (this.matchExpressions == null) {this.matchExpressions = new ArrayList<MatchExpressionsBuilder>();}
    for (MatchExpressions item : items) {MatchExpressionsBuilder builder = new MatchExpressionsBuilder(item);_visitables.get("matchExpressions").add(builder);this.matchExpressions.add(builder);} return (A)this;
  }
  
  public A removeFromMatchExpressions(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchExpressions... items) {
  ...
  public A removeAllFromPodMatchExpressions(Collection<MatchExpressions> items) {
    if (this.matchExpressions == null) return (A)this;
    for (MatchExpressions item : items) {MatchExpressionsBuilder builder = new MatchExpressionsBuilder(item);_visitables.get("matchExpressions").remove(builder); this.matchExpressions.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPodMatchExpressions(Predicate<MatchExpressionsBuilder> predicate) {
  ...
  public A withMatchExpressions(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchExpressions... matchExpressions) {
    if (this.matchExpressions != null) {
  ...
  public A addToMatchFields(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchFields... items) {
    if (this.matchFields == null) {this.matchFields = new ArrayList<MatchFieldsBuilder>();}
  ...
  public A addAllToPodMatchFields(Collection<MatchFields> items) {
    if (this.matchFields == null) {this.matchFields = new ArrayList<MatchFieldsBuilder>();}
    for (MatchFields item : items) {MatchFieldsBuilder builder = new MatchFieldsBuilder(item);_visitables.get("matchFields").add(builder);this.matchFields.add(builder);} return (A)this;
  }
  
  public A removeFromMatchFields(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchFields... items) {
  ...
  public A removeAllFromPodMatchFields(Collection<MatchFields> items) {
    if (this.matchFields == null) return (A)this;
    for (MatchFields item : items) {MatchFieldsBuilder builder = new MatchFieldsBuilder(item);_visitables.get("matchFields").remove(builder); this.matchFields.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPodMatchFields(Predicate<MatchFieldsBuilder> predicate) {
  ...
  public A withMatchFields(cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.preferredduringschedulingignoredduringexecution.preference.MatchFields... matchFields) {
    if (this.matchFields != null) {
  ...
  public class MatchExpressionsNested<N> extends MatchExpressionsFluent<MatchExpressionsNested<N>> implements Nested<N>{
    ...
    public N endPodMatchExpression() {
      return and();
    }
