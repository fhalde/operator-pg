...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.LimitsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.Requests;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.ClaimsBuilder;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.Limits;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.ClaimsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.RequestsFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.Claims;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.LimitsBuilder;
import java.util.Collection;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.RequestsBuilder;
...
public class ResourcesFluent<A extends ResourcesFluent<A>> extends BaseFluent<A>{
  ...
  public A addToClaims(cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.Claims... items) {
    if (this.claims == null) {this.claims = new ArrayList<ClaimsBuilder>();}
  ...
  public A removeFromClaims(cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.Claims... items) {
  ...
  public A withClaims(cli.strimzi.kafka.v1beta2.kafkaconnectspec.build.resources.Claims... claims) {
    if (this.claims != null) {
        this.claims.clear();
