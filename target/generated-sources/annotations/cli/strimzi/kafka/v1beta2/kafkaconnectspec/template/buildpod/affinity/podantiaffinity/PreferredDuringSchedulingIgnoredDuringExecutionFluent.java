...
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.preferredduringschedulingignoredduringexecution.PodAffinityTermBuilder;
import java.lang.String;
import java.util.LinkedHashMap;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.preferredduringschedulingignoredduringexecution.PodAffinityTerm;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podantiaffinity.preferredduringschedulingignoredduringexecution.PodAffinityTermFluent;
...
public class PreferredDuringSchedulingIgnoredDuringExecutionFluent<A extends PreferredDuringSchedulingIgnoredDuringExecutionFluent<A>> extends BaseFluent<A>{
  ...
  public PodAffinityTermNested<A> editPodantiaffinityPodAffinityTerm() {
  ...
  public class PodAffinityTermNested<N> extends PodAffinityTermFluent<PodAffinityTermNested<N>> implements Nested<N>{
    ...
    public N endPodantiaffinityPodAffinityTerm() {
      return and();
    }
