package cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.clusterrolebinding;

import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.clusterrolebinding.metadata.LabelsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.clusterrolebinding.metadata.AnnotationsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.clusterrolebinding.metadata.Labels;
import java.lang.String;
import java.util.LinkedHashMap;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.clusterrolebinding.metadata.LabelsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.clusterrolebinding.metadata.Annotations;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.clusterrolebinding.metadata.AnnotationsBuilder;
...
public class MetadataFluent<A extends MetadataFluent<A>> extends BaseFluent<A>{
  ...
  public AnnotationsNested<A> editClusterrolebindingAnnotations() {
  ...
  public LabelsNested<A> editClusterrolebindingLabels() {
  ...
  public class AnnotationsNested<N> extends AnnotationsFluent<AnnotationsNested<N>> implements Nested<N>{
    ...
    public N endClusterrolebindingAnnotations() {
      return and();
    }
  ...
  public class LabelsNested<N> extends LabelsFluent<LabelsNested<N>> implements Nested<N>{
    ...
    public N endClusterrolebindingLabels() {
      return and();
    }
