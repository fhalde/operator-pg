package cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.poddisruptionbudget;

import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.poddisruptionbudget.metadata.LabelsBuilder;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.poddisruptionbudget.metadata.AnnotationsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.poddisruptionbudget.metadata.Labels;
import java.lang.String;
import java.util.LinkedHashMap;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.poddisruptionbudget.metadata.LabelsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.poddisruptionbudget.metadata.Annotations;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import cli.strimzi.kafka.v1beta2.kafkaconnectspec.template.poddisruptionbudget.metadata.AnnotationsBuilder;
...
public class MetadataFluent<A extends MetadataFluent<A>> extends BaseFluent<A>{
  ...
  public AnnotationsNested<A> editPoddisruptionbudgetAnnotations() {
  ...
  public LabelsNested<A> editPoddisruptionbudgetLabels() {
  ...
  public class AnnotationsNested<N> extends AnnotationsFluent<AnnotationsNested<N>> implements Nested<N>{
    ...
    public N endPoddisruptionbudgetAnnotations() {
      return and();
    }
  ...
  public class LabelsNested<N> extends LabelsFluent<LabelsNested<N>> implements Nested<N>{
    ...
    public N endPoddisruptionbudgetLabels() {
      return and();
    }
