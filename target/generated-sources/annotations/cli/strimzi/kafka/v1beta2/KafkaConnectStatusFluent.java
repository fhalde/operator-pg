...
import cli.strimzi.kafka.v1beta2.kafkaconnectstatus.ConditionsFluent;
import java.lang.String;
import cli.strimzi.kafka.v1beta2.kafkaconnectstatus.ConnectorPluginsFluent;
import cli.strimzi.kafka.v1beta2.kafkaconnectstatus.Conditions;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import cli.strimzi.kafka.v1beta2.kafkaconnectstatus.ConnectorPluginsBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import cli.strimzi.kafka.v1beta2.kafkaconnectstatus.ConditionsBuilder;
import java.lang.Long;
import java.util.Collection;
import cli.strimzi.kafka.v1beta2.kafkaconnectstatus.ConnectorPlugins;
...
public class KafkaConnectStatusFluent<A extends KafkaConnectStatusFluent<A>> extends BaseFluent<A>{
  ...
  public A addToConditions(cli.strimzi.kafka.v1beta2.kafkaconnectstatus.Conditions... items) {
    if (this.conditions == null) {this.conditions = new ArrayList<ConditionsBuilder>();}
  ...
  public A removeFromConditions(cli.strimzi.kafka.v1beta2.kafkaconnectstatus.Conditions... items) {
  ...
  public A withConditions(cli.strimzi.kafka.v1beta2.kafkaconnectstatus.Conditions... conditions) {
    if (this.conditions != null) {
  ...
  public A addToConnectorPlugins(cli.strimzi.kafka.v1beta2.kafkaconnectstatus.ConnectorPlugins... items) {
    if (this.connectorPlugins == null) {this.connectorPlugins = new ArrayList<ConnectorPluginsBuilder>();}
  ...
  public A addAllToConnectorPlugins(Collection<ConnectorPlugins> items) {
    if (this.connectorPlugins == null) {this.connectorPlugins = new ArrayList<ConnectorPluginsBuilder>();}
    for (ConnectorPlugins item : items) {ConnectorPluginsBuilder builder = new ConnectorPluginsBuilder(item);_visitables.get("connectorPlugins").add(builder);this.connectorPlugins.add(builder);} return (A)this;
  }
  
  public A removeFromConnectorPlugins(cli.strimzi.kafka.v1beta2.kafkaconnectstatus.ConnectorPlugins... items) {
  ...
  public A removeAllFromConnectorPlugins(Collection<ConnectorPlugins> items) {
    if (this.connectorPlugins == null) return (A)this;
    for (ConnectorPlugins item : items) {ConnectorPluginsBuilder builder = new ConnectorPluginsBuilder(item);_visitables.get("connectorPlugins").remove(builder); this.connectorPlugins.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromConnectorPlugins(Predicate<ConnectorPluginsBuilder> predicate) {
  ...
  public A withConnectorPlugins(cli.strimzi.kafka.v1beta2.kafkaconnectstatus.ConnectorPlugins... connectorPlugins) {
    if (this.connectorPlugins != null) {
