...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressionsBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFieldsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressions;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressionsFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFields;
import java.util.Iterator;
import java.util.List;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFieldsBuilder;
...
public class NodeSelectorTermsFluent<A extends NodeSelectorTermsFluent<A>> extends BaseFluent<A>{
  ...
  public A addToMatchExpressions(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressions... items) {
    if (this.matchExpressions == null) {this.matchExpressions = new ArrayList<MatchExpressionsBuilder>();}
  ...
  public A removeFromMatchExpressions(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressions... items) {
  ...
  public A withMatchExpressions(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchExpressions... matchExpressions) {
    if (this.matchExpressions != null) {
  ...
  public A addToMatchFields(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFields... items) {
    if (this.matchFields == null) {this.matchFields = new ArrayList<MatchFieldsBuilder>();}
  ...
  public A removeFromMatchFields(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFields... items) {
  ...
  public A withMatchFields(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.nodeselectorterms.MatchFields... matchFields) {
    if (this.matchFields != null) {
