...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.Env;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.SecurityContextBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.EnvFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.EnvBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.SecurityContext;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.SecurityContextFluent;
...
public class InitContainerFluent<A extends InitContainerFluent<A>> extends BaseFluent<A>{
  ...
  public A addToEnv(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.Env... items) {
    if (this.env == null) {this.env = new ArrayList<EnvBuilder>();}
  ...
  public A removeFromEnv(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.Env... items) {
  ...
  public A withEnv(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.initcontainer.Env... env) {
    if (this.env != null) {
        this.env.clear();
