...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Tolerations;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TolerationsBuilder;
import java.util.ArrayList;
import java.lang.String;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.SecurityContextBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TolerationsFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.List;
import java.lang.Boolean;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecretsFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliases;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.AffinityFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.SecurityContextFluent;
import java.lang.Long;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Affinity;
import java.util.Collection;
import java.lang.Object;
import java.util.Map;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraintsBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.AffinityBuilder;
import java.lang.SuppressWarnings;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.MetadataFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraints;
import io.fabric8.kubernetes.api.builder.Nested;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Metadata;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraintsFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliasesFluent;
import java.util.Iterator;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.MetadataBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecrets;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecretsBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.SecurityContext;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliasesBuilder;
...
public class PodFluent<A extends PodFluent<A>> extends BaseFluent<A>{
  ...
  public A addToHostAliases(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliases... items) {
    if (this.hostAliases == null) {this.hostAliases = new ArrayList<HostAliasesBuilder>();}
  ...
  public A removeFromHostAliases(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliases... items) {
  ...
  public A withHostAliases(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.HostAliases... hostAliases) {
    if (this.hostAliases != null) {
  ...
  public A addToImagePullSecrets(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecrets... items) {
    if (this.imagePullSecrets == null) {this.imagePullSecrets = new ArrayList<ImagePullSecretsBuilder>();}
  ...
  public A removeFromImagePullSecrets(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecrets... items) {
  ...
  public A withImagePullSecrets(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.ImagePullSecrets... imagePullSecrets) {
    if (this.imagePullSecrets != null) {
  ...
  public A addToTolerations(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Tolerations... items) {
    if (this.tolerations == null) {this.tolerations = new ArrayList<TolerationsBuilder>();}
  ...
  public A removeFromTolerations(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Tolerations... items) {
  ...
  public A withTolerations(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.Tolerations... tolerations) {
    if (this.tolerations != null) {
  ...
  public A addToTopologySpreadConstraints(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraints... items) {
    if (this.topologySpreadConstraints == null) {this.topologySpreadConstraints = new ArrayList<TopologySpreadConstraintsBuilder>();}
  ...
  public A removeFromTopologySpreadConstraints(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraints... items) {
  ...
  public A withTopologySpreadConstraints(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.TopologySpreadConstraints... topologySpreadConstraints) {
    if (this.topologySpreadConstraints != null) {
