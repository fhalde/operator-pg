...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.secret.ItemsBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Long;
import java.util.Iterator;
import java.util.Collection;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.secret.Items;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.secret.ItemsFluent;
...
public class SecretFluent<A extends SecretFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.secret.Items... items) {
    if (this.items == null) {this.items = new ArrayList<ItemsBuilder>();}
  ...
  public A removeFromItems(io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.secret.Items... items) {
  ...
  public A withItems(io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.secret.Items... items) {
    if (this.items != null) {
        this.items.clear();
