package io.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount;

import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.metadata.LabelsBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.metadata.AnnotationsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.metadata.Labels;
import java.lang.String;
import java.util.LinkedHashMap;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.metadata.LabelsFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.metadata.Annotations;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.serviceaccount.metadata.AnnotationsBuilder;
...
public class MetadataFluent<A extends MetadataFluent<A>> extends BaseFluent<A>{
  ...
  public AnnotationsNested<A> editServiceaccountAnnotations() {
  ...
  public LabelsNested<A> editServiceaccountLabels() {
  ...
  public class AnnotationsNested<N> extends AnnotationsFluent<AnnotationsNested<N>> implements Nested<N>{
    ...
    public N endServiceaccountAnnotations() {
      return and();
    }
  ...
  public class LabelsNested<N> extends LabelsFluent<LabelsNested<N>> implements Nested<N>{
    ...
    public N endServiceaccountLabels() {
      return and();
    }
