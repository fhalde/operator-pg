...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Tolerations;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.TolerationsBuilder;
import java.util.ArrayList;
import java.lang.String;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.SecurityContextBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.TolerationsFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.List;
import java.lang.Boolean;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.ImagePullSecretsFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.HostAliases;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.AffinityFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.SecurityContextFluent;
import java.lang.Long;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Affinity;
import java.util.Collection;
import java.lang.Object;
import java.util.Map;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.TopologySpreadConstraintsBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.AffinityBuilder;
import java.lang.SuppressWarnings;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.MetadataFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.TopologySpreadConstraints;
import io.fabric8.kubernetes.api.builder.Nested;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Metadata;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.TopologySpreadConstraintsFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.HostAliasesFluent;
import java.util.Iterator;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.MetadataBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.ImagePullSecrets;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.ImagePullSecretsBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.SecurityContext;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.HostAliasesBuilder;
...
public class BuildPodFluent<A extends BuildPodFluent<A>> extends BaseFluent<A>{
  ...
  public AffinityNested<A> editIoAffinity() {
  ...
  public A addToHostAliases(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.HostAliases... items) {
    if (this.hostAliases == null) {this.hostAliases = new ArrayList<HostAliasesBuilder>();}
  ...
  public A addAllToIoHostAliases(Collection<HostAliases> items) {
    if (this.hostAliases == null) {this.hostAliases = new ArrayList<HostAliasesBuilder>();}
    for (HostAliases item : items) {HostAliasesBuilder builder = new HostAliasesBuilder(item);_visitables.get("hostAliases").add(builder);this.hostAliases.add(builder);} return (A)this;
  }
  
  public A removeFromHostAliases(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.HostAliases... items) {
  ...
  public A removeAllFromIoHostAliases(Collection<HostAliases> items) {
    if (this.hostAliases == null) return (A)this;
    for (HostAliases item : items) {HostAliasesBuilder builder = new HostAliasesBuilder(item);_visitables.get("hostAliases").remove(builder); this.hostAliases.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIoHostAliases(Predicate<HostAliasesBuilder> predicate) {
  ...
  public A withHostAliases(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.HostAliases... hostAliases) {
    if (this.hostAliases != null) {
  ...
  public A addToImagePullSecrets(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.ImagePullSecrets... items) {
    if (this.imagePullSecrets == null) {this.imagePullSecrets = new ArrayList<ImagePullSecretsBuilder>();}
  ...
  public A addAllToIoImagePullSecrets(Collection<ImagePullSecrets> items) {
    if (this.imagePullSecrets == null) {this.imagePullSecrets = new ArrayList<ImagePullSecretsBuilder>();}
    for (ImagePullSecrets item : items) {ImagePullSecretsBuilder builder = new ImagePullSecretsBuilder(item);_visitables.get("imagePullSecrets").add(builder);this.imagePullSecrets.add(builder);} return (A)this;
  }
  
  public A removeFromImagePullSecrets(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.ImagePullSecrets... items) {
  ...
  public A removeAllFromIoImagePullSecrets(Collection<ImagePullSecrets> items) {
    if (this.imagePullSecrets == null) return (A)this;
    for (ImagePullSecrets item : items) {ImagePullSecretsBuilder builder = new ImagePullSecretsBuilder(item);_visitables.get("imagePullSecrets").remove(builder); this.imagePullSecrets.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIoImagePullSecrets(Predicate<ImagePullSecretsBuilder> predicate) {
  ...
  public A withImagePullSecrets(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.ImagePullSecrets... imagePullSecrets) {
    if (this.imagePullSecrets != null) {
  ...
  public A addToTolerations(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Tolerations... items) {
    if (this.tolerations == null) {this.tolerations = new ArrayList<TolerationsBuilder>();}
  ...
  public A addAllToIoTolerations(Collection<Tolerations> items) {
    if (this.tolerations == null) {this.tolerations = new ArrayList<TolerationsBuilder>();}
    for (Tolerations item : items) {TolerationsBuilder builder = new TolerationsBuilder(item);_visitables.get("tolerations").add(builder);this.tolerations.add(builder);} return (A)this;
  }
  
  public A removeFromTolerations(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Tolerations... items) {
  ...
  public A removeAllFromIoTolerations(Collection<Tolerations> items) {
    if (this.tolerations == null) return (A)this;
    for (Tolerations item : items) {TolerationsBuilder builder = new TolerationsBuilder(item);_visitables.get("tolerations").remove(builder); this.tolerations.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIoTolerations(Predicate<TolerationsBuilder> predicate) {
  ...
  public A withTolerations(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.Tolerations... tolerations) {
    if (this.tolerations != null) {
  ...
  public A addToTopologySpreadConstraints(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.TopologySpreadConstraints... items) {
    if (this.topologySpreadConstraints == null) {this.topologySpreadConstraints = new ArrayList<TopologySpreadConstraintsBuilder>();}
  ...
  public A addAllToIoTopologySpreadConstraints(Collection<TopologySpreadConstraints> items) {
    if (this.topologySpreadConstraints == null) {this.topologySpreadConstraints = new ArrayList<TopologySpreadConstraintsBuilder>();}
    for (TopologySpreadConstraints item : items) {TopologySpreadConstraintsBuilder builder = new TopologySpreadConstraintsBuilder(item);_visitables.get("topologySpreadConstraints").add(builder);this.topologySpreadConstraints.add(builder);} return (A)this;
  }
  
  public A removeFromTopologySpreadConstraints(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.TopologySpreadConstraints... items) {
  ...
  public A removeAllFromIoTopologySpreadConstraints(Collection<TopologySpreadConstraints> items) {
    if (this.topologySpreadConstraints == null) return (A)this;
    for (TopologySpreadConstraints item : items) {TopologySpreadConstraintsBuilder builder = new TopologySpreadConstraintsBuilder(item);_visitables.get("topologySpreadConstraints").remove(builder); this.topologySpreadConstraints.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIoTopologySpreadConstraints(Predicate<TopologySpreadConstraintsBuilder> predicate) {
  ...
  public A withTopologySpreadConstraints(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.TopologySpreadConstraints... topologySpreadConstraints) {
    if (this.topologySpreadConstraints != null) {
  ...
  public class TopologySpreadConstraintsNested<N> extends TopologySpreadConstraintsFluent<TopologySpreadConstraintsNested<N>> implements Nested<N>{
    ...
    public N endIoTopologySpreadConstraint() {
      return and();
    }
