package io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.volumes.configmap;
...
public class ItemsFluent<A extends ItemsFluent<A>> extends BaseFluent<A>{
  ...
  public int hashCode() {
    return java.util.Objects.hash(key,  mode,  path,  additionalProperties,  super.hashCode());
  }
