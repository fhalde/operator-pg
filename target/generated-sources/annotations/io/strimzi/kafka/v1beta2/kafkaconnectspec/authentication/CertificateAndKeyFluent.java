...
public class CertificateAndKeyFluent<A extends CertificateAndKeyFluent<A>> extends BaseFluent<A>{
  public CertificateAndKeyFluent() {
  }
  
  public CertificateAndKeyFluent(CertificateAndKey instance) {
  ...
  protected void copyInstance(CertificateAndKey instance) {
    instance = (instance != null ? instance : new CertificateAndKey());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    CertificateAndKeyFluent that = (CertificateAndKeyFluent) o;
  ...
  public int hashCode() {
    return java.util.Objects.hash(certificate,  key,  secretName,  additionalProperties,  super.hashCode());
  }
