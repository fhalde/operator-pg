...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.env.ValueFrom;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.env.ValueFromBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.externalconfiguration.env.ValueFromFluent;
...
public class EnvFluent<A extends EnvFluent<A>> extends BaseFluent<A>{
  ...
  public ValueFromNested<A> editIoValueFrom() {
