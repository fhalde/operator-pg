...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.tls.TrustedCertificates;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.tls.TrustedCertificatesFluent;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.tls.TrustedCertificatesBuilder;
...
public class TlsFluent<A extends TlsFluent<A>> extends BaseFluent<A>{
  ...
  public A addToTrustedCertificates(io.strimzi.kafka.v1beta2.kafkaconnectspec.tls.TrustedCertificates... items) {
    if (this.trustedCertificates == null) {this.trustedCertificates = new ArrayList<TrustedCertificatesBuilder>();}
  ...
  public A addAllToIoTrustedCertificates(Collection<TrustedCertificates> items) {
    if (this.trustedCertificates == null) {this.trustedCertificates = new ArrayList<TrustedCertificatesBuilder>();}
    for (TrustedCertificates item : items) {TrustedCertificatesBuilder builder = new TrustedCertificatesBuilder(item);_visitables.get("trustedCertificates").add(builder);this.trustedCertificates.add(builder);} return (A)this;
  }
  
  public A removeFromTrustedCertificates(io.strimzi.kafka.v1beta2.kafkaconnectspec.tls.TrustedCertificates... items) {
  ...
  public A removeAllFromIoTrustedCertificates(Collection<TrustedCertificates> items) {
    if (this.trustedCertificates == null) return (A)this;
    for (TrustedCertificates item : items) {TrustedCertificatesBuilder builder = new TrustedCertificatesBuilder(item);_visitables.get("trustedCertificates").remove(builder); this.trustedCertificates.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIoTrustedCertificates(Predicate<TrustedCertificatesBuilder> predicate) {
  ...
  public A withTrustedCertificates(io.strimzi.kafka.v1beta2.kafkaconnectspec.tls.TrustedCertificates... trustedCertificates) {
    if (this.trustedCertificates != null) {
  ...
  public class TrustedCertificatesNested<N> extends TrustedCertificatesFluent<TrustedCertificatesNested<N>> implements Nested<N>{
    ...
    public N endIoTrustedCertificate() {
      return and();
    }
