...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTerms;
...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTermsFluent;
import java.util.Map;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTermsBuilder;
...
public class RequiredDuringSchedulingIgnoredDuringExecutionFluent<A extends RequiredDuringSchedulingIgnoredDuringExecutionFluent<A>> extends BaseFluent<A>{
  ...
  public A addToNodeSelectorTerms(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTerms... items) {
    if (this.nodeSelectorTerms == null) {this.nodeSelectorTerms = new ArrayList<NodeSelectorTermsBuilder>();}
  ...
  public A addAllToIoNodeSelectorTerms(Collection<NodeSelectorTerms> items) {
    if (this.nodeSelectorTerms == null) {this.nodeSelectorTerms = new ArrayList<NodeSelectorTermsBuilder>();}
    for (NodeSelectorTerms item : items) {NodeSelectorTermsBuilder builder = new NodeSelectorTermsBuilder(item);_visitables.get("nodeSelectorTerms").add(builder);this.nodeSelectorTerms.add(builder);} return (A)this;
  }
  
  public A removeFromNodeSelectorTerms(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTerms... items) {
  ...
  public A removeAllFromIoNodeSelectorTerms(Collection<NodeSelectorTerms> items) {
    if (this.nodeSelectorTerms == null) return (A)this;
    for (NodeSelectorTerms item : items) {NodeSelectorTermsBuilder builder = new NodeSelectorTermsBuilder(item);_visitables.get("nodeSelectorTerms").remove(builder); this.nodeSelectorTerms.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIoNodeSelectorTerms(Predicate<NodeSelectorTermsBuilder> predicate) {
  ...
  public A withNodeSelectorTerms(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTerms... nodeSelectorTerms) {
    if (this.nodeSelectorTerms != null) {
  ...
  public class NodeSelectorTermsNested<N> extends NodeSelectorTermsFluent<NodeSelectorTermsNested<N>> implements Nested<N>{
    ...
    public N endIoNodeSelectorTerm() {
      return and();
    }
