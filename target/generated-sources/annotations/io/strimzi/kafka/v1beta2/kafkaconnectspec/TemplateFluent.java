...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildPodBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildPod;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ClusterRoleBinding;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.InitContainer;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.Deployment;
import java.lang.String;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.PodDisruptionBudgetBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildConfigBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ApiServiceFluent;
import java.util.LinkedHashMap;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.HeadlessServiceBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildConfig;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.JmxSecretBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ClusterRoleBindingBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.Pod;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ConnectContainerFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.PodBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ServiceAccountBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildConfigFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.PodSetFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.PodFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.PodSet;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.HeadlessServiceFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ApiService;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.InitContainerFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ApiServiceBuilder;
import java.lang.Object;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildPodFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildServiceAccount;
import java.util.Map;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.DeploymentBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.InitContainerBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.JmxSecretFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ServiceAccount;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.PodDisruptionBudget;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.HeadlessService;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ServiceAccountFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildContainerBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildContainerFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.DeploymentFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildContainer;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ClusterRoleBindingFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildServiceAccountBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.BuildServiceAccountFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.PodDisruptionBudgetFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.JmxSecret;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ConnectContainerBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.ConnectContainer;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.PodSetBuilder;
...
public class TemplateFluent<A extends TemplateFluent<A>> extends BaseFluent<A>{
  ...
  public ApiServiceNested<A> editIoApiService() {
  ...
  public BuildConfigNested<A> editIoBuildConfig() {
  ...
  public BuildContainerNested<A> editIoBuildContainer() {
  ...
  public BuildPodNested<A> editIoBuildPod() {
  ...
  public BuildServiceAccountNested<A> editIoBuildServiceAccount() {
  ...
  public ClusterRoleBindingNested<A> editIoClusterRoleBinding() {
  ...
  public ConnectContainerNested<A> editIoConnectContainer() {
  ...
  public DeploymentNested<A> editIoDeployment() {
  ...
  public HeadlessServiceNested<A> editIoHeadlessService() {
  ...
  public InitContainerNested<A> editIoInitContainer() {
  ...
  public JmxSecretNested<A> editIoJmxSecret() {
  ...
  public PodDisruptionBudgetNested<A> editIoPodDisruptionBudget() {
  ...
  public PodSetNested<A> editIoPodSet() {
  ...
  public ServiceAccountNested<A> editIoServiceAccount() {
  ...
  public class BuildServiceAccountNested<N> extends BuildServiceAccountFluent<BuildServiceAccountNested<N>> implements Nested<N>{
    ...
    public N endIoBuildServiceAccount() {
      return and();
    }
  ...
  public class ClusterRoleBindingNested<N> extends ClusterRoleBindingFluent<ClusterRoleBindingNested<N>> implements Nested<N>{
    ...
    public N endIoClusterRoleBinding() {
      return and();
    }
  ...
  public class ConnectContainerNested<N> extends ConnectContainerFluent<ConnectContainerNested<N>> implements Nested<N>{
    ...
    public N endIoConnectContainer() {
      return and();
    }
  ...
  public class PodDisruptionBudgetNested<N> extends PodDisruptionBudgetFluent<PodDisruptionBudgetNested<N>> implements Nested<N>{
    ...
    public N endIoPodDisruptionBudget() {
      return and();
    }
