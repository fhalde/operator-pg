...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions._XXBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions._XXFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import java.lang.Boolean;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions._XX;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions.JavaSystemPropertiesFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions.JavaSystemPropertiesBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions.JavaSystemProperties;
...
public class JvmOptionsFluent<A extends JvmOptionsFluent<A>> extends BaseFluent<A>{
  ...
  public A addToJavaSystemProperties(io.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions.JavaSystemProperties... items) {
    if (this.javaSystemProperties == null) {this.javaSystemProperties = new ArrayList<JavaSystemPropertiesBuilder>();}
  ...
  public A addAllToIoJavaSystemProperties(Collection<JavaSystemProperties> items) {
    if (this.javaSystemProperties == null) {this.javaSystemProperties = new ArrayList<JavaSystemPropertiesBuilder>();}
    for (JavaSystemProperties item : items) {JavaSystemPropertiesBuilder builder = new JavaSystemPropertiesBuilder(item);_visitables.get("javaSystemProperties").add(builder);this.javaSystemProperties.add(builder);} return (A)this;
  }
  
  public A removeFromJavaSystemProperties(io.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions.JavaSystemProperties... items) {
  ...
  public A removeAllFromIoJavaSystemProperties(Collection<JavaSystemProperties> items) {
    if (this.javaSystemProperties == null) return (A)this;
    for (JavaSystemProperties item : items) {JavaSystemPropertiesBuilder builder = new JavaSystemPropertiesBuilder(item);_visitables.get("javaSystemProperties").remove(builder); this.javaSystemProperties.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIoJavaSystemProperties(Predicate<JavaSystemPropertiesBuilder> predicate) {
  ...
  public A withJavaSystemProperties(io.strimzi.kafka.v1beta2.kafkaconnectspec.jvmoptions.JavaSystemProperties... javaSystemProperties) {
    if (this.javaSystemProperties != null) {
  ...
  public class JavaSystemPropertiesNested<N> extends JavaSystemPropertiesFluent<JavaSystemPropertiesNested<N>> implements Nested<N>{
    ...
    public N endIoJavaSystemProperty() {
      return and();
    }
