...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.Sysctls;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeccompProfile;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeccompProfileBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeLinuxOptionsBuilder;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeLinuxOptions;
import java.util.List;
import java.lang.Boolean;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.WindowsOptionsFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SysctlsBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.WindowsOptionsBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeLinuxOptionsFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.WindowsOptions;
import java.lang.Long;
import java.util.Collection;
import java.lang.Object;
import java.util.Map;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SeccompProfileFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.SysctlsFluent;
...
public class SecurityContextFluent<A extends SecurityContextFluent<A>> extends BaseFluent<A>{
  ...
  public A addToSysctls(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.Sysctls... items) {
    if (this.sysctls == null) {this.sysctls = new ArrayList<SysctlsBuilder>();}
  ...
  public A removeFromSysctls(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.Sysctls... items) {
  ...
  public A withSysctls(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.securitycontext.Sysctls... sysctls) {
    if (this.sysctls != null) {
        this.sysctls.clear();
