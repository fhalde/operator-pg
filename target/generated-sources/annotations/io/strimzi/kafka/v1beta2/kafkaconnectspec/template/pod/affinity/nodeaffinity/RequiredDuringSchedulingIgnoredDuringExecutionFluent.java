...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTerms;
...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTermsFluent;
import java.util.Map;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTermsBuilder;
...
public class RequiredDuringSchedulingIgnoredDuringExecutionFluent<A extends RequiredDuringSchedulingIgnoredDuringExecutionFluent<A>> extends BaseFluent<A>{
  ...
  public A addToNodeSelectorTerms(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTerms... items) {
    if (this.nodeSelectorTerms == null) {this.nodeSelectorTerms = new ArrayList<NodeSelectorTermsBuilder>();}
  ...
  public A removeFromNodeSelectorTerms(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTerms... items) {
  ...
  public A withNodeSelectorTerms(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.requiredduringschedulingignoredduringexecution.NodeSelectorTerms... nodeSelectorTerms) {
    if (this.nodeSelectorTerms != null) {
