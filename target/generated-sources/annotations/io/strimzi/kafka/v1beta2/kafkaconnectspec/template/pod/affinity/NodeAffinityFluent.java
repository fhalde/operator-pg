...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecutionBuilder;
import io.fabric8.kubernetes.api.builder.VisitableBuilder;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.RequiredDuringSchedulingIgnoredDuringExecutionFluent;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecution;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.RequiredDuringSchedulingIgnoredDuringExecution;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.RequiredDuringSchedulingIgnoredDuringExecutionBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecutionFluent;
...
public class NodeAffinityFluent<A extends NodeAffinityFluent<A>> extends BaseFluent<A>{
  ...
  public A addToPreferredDuringSchedulingIgnoredDuringExecution(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecution... items) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution == null) {this.preferredDuringSchedulingIgnoredDuringExecution = new ArrayList<PreferredDuringSchedulingIgnoredDuringExecutionBuilder>();}
  ...
  public A addAllToPodPreferredDuringSchedulingIgnoredDuringExecution(Collection<PreferredDuringSchedulingIgnoredDuringExecution> items) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution == null) {this.preferredDuringSchedulingIgnoredDuringExecution = new ArrayList<PreferredDuringSchedulingIgnoredDuringExecutionBuilder>();}
    for (PreferredDuringSchedulingIgnoredDuringExecution item : items) {PreferredDuringSchedulingIgnoredDuringExecutionBuilder builder = new PreferredDuringSchedulingIgnoredDuringExecutionBuilder(item);_visitables.get("preferredDuringSchedulingIgnoredDuringExecution").add(builder);this.preferredDuringSchedulingIgnoredDuringExecution.add(builder);} return (A)this;
  }
  
  public A removeFromPreferredDuringSchedulingIgnoredDuringExecution(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecution... items) {
  ...
  public A removeAllFromPodPreferredDuringSchedulingIgnoredDuringExecution(Collection<PreferredDuringSchedulingIgnoredDuringExecution> items) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution == null) return (A)this;
    for (PreferredDuringSchedulingIgnoredDuringExecution item : items) {PreferredDuringSchedulingIgnoredDuringExecutionBuilder builder = new PreferredDuringSchedulingIgnoredDuringExecutionBuilder(item);_visitables.get("preferredDuringSchedulingIgnoredDuringExecution").remove(builder); this.preferredDuringSchedulingIgnoredDuringExecution.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPodPreferredDuringSchedulingIgnoredDuringExecution(Predicate<PreferredDuringSchedulingIgnoredDuringExecutionBuilder> predicate) {
  ...
  public A withPreferredDuringSchedulingIgnoredDuringExecution(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.pod.affinity.nodeaffinity.PreferredDuringSchedulingIgnoredDuringExecution... preferredDuringSchedulingIgnoredDuringExecution) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution != null) {
  ...
  public RequiredDuringSchedulingIgnoredDuringExecutionNested<A> editPodRequiredDuringSchedulingIgnoredDuringExecution() {
  ...
  public class PreferredDuringSchedulingIgnoredDuringExecutionNested<N> extends PreferredDuringSchedulingIgnoredDuringExecutionFluent<PreferredDuringSchedulingIgnoredDuringExecutionNested<N>> implements Nested<N>{
    ...
    public N endPodPreferredDuringSchedulingIgnoredDuringExecution() {
      return and();
    }
  ...
  public class RequiredDuringSchedulingIgnoredDuringExecutionNested<N> extends RequiredDuringSchedulingIgnoredDuringExecutionFluent<RequiredDuringSchedulingIgnoredDuringExecutionNested<N>> implements Nested<N>{
    ...
    public N endPodRequiredDuringSchedulingIgnoredDuringExecution() {
      return and();
    }
