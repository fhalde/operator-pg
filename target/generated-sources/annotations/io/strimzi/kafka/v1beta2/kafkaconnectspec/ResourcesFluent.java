...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.LimitsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Requests;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.ClaimsBuilder;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Limits;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.ClaimsFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.RequestsFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Claims;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.LimitsBuilder;
import java.util.Collection;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.RequestsBuilder;
...
public class ResourcesFluent<A extends ResourcesFluent<A>> extends BaseFluent<A>{
  ...
  public A addToClaims(io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Claims... items) {
    if (this.claims == null) {this.claims = new ArrayList<ClaimsBuilder>();}
  ...
  public A removeFromClaims(io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Claims... items) {
  ...
  public A withClaims(io.strimzi.kafka.v1beta2.kafkaconnectspec.resources.Claims... claims) {
    if (this.claims != null) {
        this.claims.clear();
