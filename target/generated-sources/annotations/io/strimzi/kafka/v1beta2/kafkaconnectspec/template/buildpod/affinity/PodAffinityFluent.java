...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.PreferredDuringSchedulingIgnoredDuringExecutionBuilder;
import io.fabric8.kubernetes.api.builder.VisitableBuilder;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.RequiredDuringSchedulingIgnoredDuringExecutionFluent;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.PreferredDuringSchedulingIgnoredDuringExecution;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.RequiredDuringSchedulingIgnoredDuringExecution;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.RequiredDuringSchedulingIgnoredDuringExecutionBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.PreferredDuringSchedulingIgnoredDuringExecutionFluent;
...
public class PodAffinityFluent<A extends PodAffinityFluent<A>> extends BaseFluent<A>{
  ...
  public A addToPreferredDuringSchedulingIgnoredDuringExecution(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.PreferredDuringSchedulingIgnoredDuringExecution... items) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution == null) {this.preferredDuringSchedulingIgnoredDuringExecution = new ArrayList<PreferredDuringSchedulingIgnoredDuringExecutionBuilder>();}
  ...
  public A removeFromPreferredDuringSchedulingIgnoredDuringExecution(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.PreferredDuringSchedulingIgnoredDuringExecution... items) {
  ...
  public A withPreferredDuringSchedulingIgnoredDuringExecution(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.PreferredDuringSchedulingIgnoredDuringExecution... preferredDuringSchedulingIgnoredDuringExecution) {
    if (this.preferredDuringSchedulingIgnoredDuringExecution != null) {
  ...
  public A addToRequiredDuringSchedulingIgnoredDuringExecution(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.RequiredDuringSchedulingIgnoredDuringExecution... items) {
    if (this.requiredDuringSchedulingIgnoredDuringExecution == null) {this.requiredDuringSchedulingIgnoredDuringExecution = new ArrayList<RequiredDuringSchedulingIgnoredDuringExecutionBuilder>();}
  ...
  public A removeFromRequiredDuringSchedulingIgnoredDuringExecution(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.RequiredDuringSchedulingIgnoredDuringExecution... items) {
  ...
  public A withRequiredDuringSchedulingIgnoredDuringExecution(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.affinity.podaffinity.RequiredDuringSchedulingIgnoredDuringExecution... requiredDuringSchedulingIgnoredDuringExecution) {
    if (this.requiredDuringSchedulingIgnoredDuringExecution != null) {
