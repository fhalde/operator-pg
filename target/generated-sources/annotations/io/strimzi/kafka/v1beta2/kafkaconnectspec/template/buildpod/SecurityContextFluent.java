...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.Sysctls;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.SeccompProfile;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.SeccompProfileBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.SeLinuxOptionsBuilder;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.SeLinuxOptions;
import java.util.List;
import java.lang.Boolean;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.WindowsOptionsFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.SysctlsBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.WindowsOptionsBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.SeLinuxOptionsFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.WindowsOptions;
import java.lang.Long;
import java.util.Collection;
import java.lang.Object;
import java.util.Map;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.SeccompProfileFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.SysctlsFluent;
...
public class SecurityContextFluent<A extends SecurityContextFluent<A>> extends BaseFluent<A>{
  ...
  public A addToSysctls(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.Sysctls... items) {
    if (this.sysctls == null) {this.sysctls = new ArrayList<SysctlsBuilder>();}
  ...
  public A addAllToIoSysctls(Collection<Sysctls> items) {
    if (this.sysctls == null) {this.sysctls = new ArrayList<SysctlsBuilder>();}
    for (Sysctls item : items) {SysctlsBuilder builder = new SysctlsBuilder(item);_visitables.get("sysctls").add(builder);this.sysctls.add(builder);} return (A)this;
  }
  
  public A removeFromSysctls(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.Sysctls... items) {
  ...
  public A removeAllFromIoSysctls(Collection<Sysctls> items) {
    if (this.sysctls == null) return (A)this;
    for (Sysctls item : items) {SysctlsBuilder builder = new SysctlsBuilder(item);_visitables.get("sysctls").remove(builder); this.sysctls.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIoSysctls(Predicate<SysctlsBuilder> predicate) {
  ...
  public A withSysctls(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildpod.securitycontext.Sysctls... sysctls) {
    if (this.sysctls != null) {
        this.sysctls.clear();
