...
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.Env;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.SecurityContextBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.EnvFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.EnvBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.SecurityContext;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.SecurityContextFluent;
...
public class BuildContainerFluent<A extends BuildContainerFluent<A>> extends BaseFluent<A>{
  public BuildContainerFluent() {
  }
  
  public BuildContainerFluent(BuildContainer instance) {
  ...
  protected void copyInstance(BuildContainer instance) {
    instance = (instance != null ? instance : new BuildContainer());
    if (instance != null) {
  ...
  public A addToEnv(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.Env... items) {
    if (this.env == null) {this.env = new ArrayList<EnvBuilder>();}
  ...
  public A addAllToBuildcontainerEnv(Collection<Env> items) {
    if (this.env == null) {this.env = new ArrayList<EnvBuilder>();}
    for (Env item : items) {EnvBuilder builder = new EnvBuilder(item);_visitables.get("env").add(builder);this.env.add(builder);} return (A)this;
  }
  
  public A removeFromEnv(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.Env... items) {
  ...
  public A removeAllFromBuildcontainerEnv(Collection<Env> items) {
    if (this.env == null) return (A)this;
    for (Env item : items) {EnvBuilder builder = new EnvBuilder(item);_visitables.get("env").remove(builder); this.env.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromBuildcontainerEnv(Predicate<EnvBuilder> predicate) {
  ...
  public A withEnv(io.strimzi.kafka.v1beta2.kafkaconnectspec.template.buildcontainer.Env... env) {
    if (this.env != null) {
        this.env.clear();
  ...
  public SecurityContextNested<A> editIoSecurityContext() {
  ...
  public boolean equals(Object o) {
    ...
    BuildContainerFluent that = (BuildContainerFluent) o;
  ...
  public class EnvNested<N> extends EnvFluent<EnvNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BuildContainerFluent.this.setToEnv(index,builder.build());
    }
    
    public N endBuildcontainerEnv() {
      return and();
    }
  ...
  public class SecurityContextNested<N> extends SecurityContextFluent<SecurityContextNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BuildContainerFluent.this.withSecurityContext(builder.build());
    }
    
    public N endIoSecurityContext() {
      return and();
    }
