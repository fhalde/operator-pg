package io.strimzi.kafka.v1beta2.kafkaconnectspec.template.jmxsecret;

import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.jmxsecret.metadata.LabelsBuilder;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.jmxsecret.metadata.AnnotationsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.jmxsecret.metadata.Labels;
import java.lang.String;
import java.util.LinkedHashMap;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.jmxsecret.metadata.LabelsFluent;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.jmxsecret.metadata.Annotations;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import io.strimzi.kafka.v1beta2.kafkaconnectspec.template.jmxsecret.metadata.AnnotationsBuilder;
...
public class MetadataFluent<A extends MetadataFluent<A>> extends BaseFluent<A>{
  ...
  public AnnotationsNested<A> editJmxsecretAnnotations() {
  ...
  public LabelsNested<A> editJmxsecretLabels() {
  ...
  public class AnnotationsNested<N> extends AnnotationsFluent<AnnotationsNested<N>> implements Nested<N>{
    ...
    public N endJmxsecretAnnotations() {
      return and();
    }
